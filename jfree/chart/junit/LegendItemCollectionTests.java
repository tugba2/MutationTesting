 ...
 * Contributor(s):   -;
 *
 * $Id: LegendItemCollectionTests.java,v 1.4 2005/12/12 14:11:31 mungady Exp $
 *
 * Changes
 * -------
...
public class LegendItemCollectionTests extends TestCase {
    ...
    public void testSerialization() {
        LegendItemCollection c1 = new LegendItemCollection();
        c1.add(new LegendItem(new AttributedString("Label"), "Description", 
                "ToolTip", "URL", 
    ...
    public void testCloning() {
        LegendItemCollection c1 = new LegendItemCollection();
        c1.add(new LegendItem(new AttributedString("Label"), "Description", 
                "ToolTip", "URL", new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0), 
                Color.red)); 
        LegendItemCollection c2 = null;
        try {
