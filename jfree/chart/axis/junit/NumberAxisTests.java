 ...
 * Contributor(s):   -;
 *
 * $Id: NumberAxisTests.java,v 1.8 2006/01/11 12:10:16 mungady Exp $
 *
 * Changes
 * -------
...
public class NumberAxisTests extends TestCase {
    ...
    /** 
     * The amount of variation acceptable in a dimension, returned by a test,
     * that relies on font bounds.
     */
    public static final double EPSILON_F = 0.25;

    /**
     * Some tests for the arrangement with no constraints.
     */
    public void testArrangeNN() {
        ...
        ArrangeResult r = axis.arrange(g2, RectangleConstraint.NONE, 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
        assertEquals(39.59, r.getHeight(), EPSILON_F);
        
        axis.setDefaultHeight(23.4);
        r = axis.arrange(g2, RectangleConstraint.NONE, new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
        assertEquals(23.4, r.getHeight(), EPSILON);
    }

    /**
     * Some tests for the arrangement with fixed width and height constraints.
     */
    public void testArrangeFF() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = axis.arrange(g2, new RectangleConstraint(123.4, 56.7), 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
    ...
    /**
     * Some tests for the arrangement with a fixed width constraint and no 
     * height constraint.
     */
    public void testArrangeFN() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = axis.arrange(g2, new RectangleConstraint(99.9, null), 
                new ArrangeParams());
    ...
    /**
     * Some tests for the arrangement with no width constraint and a fixed 
     * height constraint.
     */
    public void testArrangeNF() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = axis.arrange(g2, new RectangleConstraint(null, 29.9), 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
