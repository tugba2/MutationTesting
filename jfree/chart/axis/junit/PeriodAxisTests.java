 ...
 * Contributor(s):   -;
 *
 * $Id: PeriodAxisTests.java,v 1.9 2005/07/19 14:28:11 mungady Exp $
 *
 * Changes
 * -------
...
public class PeriodAxisTests extends TestCase {
    ...
    /** The tolerance for testing results. */
    public static final double EPSILON = 0.0000000001;
    
    /**
     * Tests the arrange method with no constraints.
     */
    public void testArrangeNN() {
        ...
        assertEquals(59.96, r.getHeight(), EPSILON_F);
    }
    
    /**
     * Tests the arrange method with a fixed width and a fixed height.
     */
    ...
    /**
     * Tests the arrange method with a fixed width and no height constraint.
     */
    public void testArrangeFN() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = axis.arrange(g2, new RectangleConstraint(98.7, null), 
                new ArrangeParams());
        assertEquals(98.7, r.getWidth(), EPSILON);
        assertEquals(59.96, r.getHeight(), EPSILON_F);        
    }
    
    /**
     * Tests the arrange method with no width constraint and a fixed height.
     */
    public void testArrangeNF() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = axis.arrange(g2, new RectangleConstraint(null, 98.7), 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
        assertEquals(98.7, r.getHeight(), EPSILON);        
    }
