 ...
 * Contributor(s):   -;
 *
 * $Id: ColumnArrangementTests.java,v 1.2 2005/07/19 14:25:20 mungady Exp $
 *
 * Changes
 * -------
...
public class ColumnArrangementTests extends TestCase {
    ...
    public void testSizingFN() {
        ...
        ColumnArrangement ca = new ColumnArrangement(HorizontalAlignment.LEFT, 
                VerticalAlignment.TOP, 1.0, 2.0);  
        BlockContainer container = new BlockContainer(ca);
        ...
        assertEquals(6.0, r.getHeight(), EPSILON);
    }
