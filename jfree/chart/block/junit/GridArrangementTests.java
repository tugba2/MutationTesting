 ...
 * Contributor(s):   -;
 *
 * $Id: GridArrangementTests.java,v 1.3 2005/07/19 14:25:21 mungady Exp $
 *
 * Changes
 * -------
...
public class GridArrangementTests extends TestCase {
    ...
    public void testNN() {
        ...
        ArrangeResult r = c.arrange(null, RectangleConstraint.NONE, 
                new ArrangeParams());
        assertEquals(90.0, r.getWidth(), EPSILON);
        assertEquals(33.0, r.getHeight(), EPSILON);
    }
    ...
    public void testFN() {
        ...
        ArrangeResult r = c.arrange(null, constraint, new ArrangeParams());
