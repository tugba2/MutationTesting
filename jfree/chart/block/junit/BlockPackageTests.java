 ...
 * Contributor(s):   -;
 *
 * $Id: BlockPackageTests.java,v 1.7 2005/11/16 11:03:58 mungady Exp $
 *
 * Changes:
 * --------
...
public class BlockPackageTests extends TestCase {
    ...
    public static Test disabledsuite() {
        ...
        suite.addTestSuite(AbstractContentBlockTests.class);
        suite.addTestSuite(ACIUtilitiesTests.class);
