 ...
 * Contributor(s):   -;
 *
 * $Id: TitlePackageTests.java,v 1.7 2005/10/27 13:07:20 mungady Exp $
 *
 * Changes:
 * --------
 * 17-Feb-2004 : Version 1 (DG);
 * 19-Jan-2005 : Added main() method to run JUnit in text mode (DG);
 * 05-Sep-2005 : Added tests for LegendGraphic class (DG);
 *
 */
...
public class TitlePackageTests extends TestCase {
    ...
    public static Test disabledSuite() {
        ...
        suite.addTestSuite(AttributedTextTitleTests.class);
