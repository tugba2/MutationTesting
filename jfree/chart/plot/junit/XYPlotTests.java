 ...
 * Contributor(s):   -;
 *
 * $Id: XYPlotTests.java,v 1.16 2006/09/04 15:02:29 mungady Exp $
 *
 * Changes
 * -------
...
public class XYPlotTests extends TestCase {
    ...
    public void testEquals() {
        ...
        plot1.setRangeZeroBaselinePaint(new GradientPaint(1.0f, 2.0f, 
                Color.white, 3.0f, 4.0f, Color.red));
        assertFalse(plot1.equals(plot2));
    ...
    public void testArrangeNN() {
        XYPlot plot = new XYPlot();
        plot.setDefaultWidth(123.4);
        plot.setDefaultHeight(234.5);
        plot.setMargin(1.0, 2.0, 3.0, 4.0);
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = plot.arrange(g2, RectangleConstraint.NONE, 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
        assertEquals(234.5, r.getHeight(), EPSILON);
    }
    ...
    public void testArrangeFF() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = plot.arrange(g2, new RectangleConstraint(123.4, 56.7), 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
    ...
    /**
     * Some tests for the arrangement with fixed width and no height 
     * constraints.
     */
    public void testArrangeFN() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = plot.arrange(g2, new RectangleConstraint(99.9, null), 
                new ArrangeParams());
    ...
    /**
     * Some tests for the arrangement with no width and fixed height 
     * constraints.
     */
    public void testArrangeNF() {
        ...
        BufferedImage image = new BufferedImage(100, 80, 
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = image.createGraphics();
        ArrangeResult r = plot.arrange(g2, new RectangleConstraint(null, 29.9), 
                new ArrangeParams());
        assertEquals(123.4, r.getWidth(), EPSILON);
