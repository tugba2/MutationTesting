 ...
 * Contributor(s):   -;
 *
 * $Id: PiePlotTests.java,v 1.11 2006/09/04 15:02:02 mungady Exp $
 *
 * Changes
 * -------
 * 18-Mar-2003 : Version 1 (DG);
 * 10-May-2005 : Strengthened equals() test (DG);
 * 09-Jan-2006 : Added checks for bug 1400442 (DG);
 *
 */
...
public class PiePlotTests extends TestCase {
    ...
    public void testEquals() {
        ...
        plot1.setBaseSectionOutlineStroke(new BasicStroke(1.23f));
        assertFalse(plot1.equals(plot2));
        plot2.setBaseSectionOutlineStroke(new BasicStroke(1.23f));
        assertTrue(plot1.equals(plot2));
